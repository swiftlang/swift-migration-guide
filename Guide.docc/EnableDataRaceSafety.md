...
If you're working with an existing Swift package that you want to migrate to enable data race safety checking, see <doc:CompleteChecking>.
...
A `Package.swift` file that uses `swift-tools-version` of `6.0` enables the Swift 6 language
